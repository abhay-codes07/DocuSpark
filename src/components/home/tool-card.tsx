  ...
  return (
    ...
    >
      ...
      <div className="mb-2 flex items-center justify-between gap-3">
        ...
        <ArrowUpRight className="size-4 text-zinc-400 ui-transition group-hover:text-zinc-700" aria-hidden="true" />
      </div>
      <p className="text-sm leading-6 text-zinc-600">{tool.description}</p>
      <p className="mt-4 text-xs font-semibold uppercase tracking-[0.12em] text-sky-700">{tool.badge}</p>
    </Link>
  );
}
